...
export default function ItemsFood({ItemsFood}) {
    ...
    return(
        <div className="card relative mt-[6rem] mb-[10rem] bg-[#F2F1EE] text-[#052130]">
            ...
            <div className="card-main w-full absolute top-0 bg-[#F2F1EE] text-[#052130] rounded-[15px] text-center border-2 "> 
                ...
                <div className="card-footer">
                        <div className="text-3xl rounded-b-[15px] w-full pb-3 px-5 text-[#052130] shadow-md flex justify-start">{`${price}`}</div>
                </div>
            </div>
        </div>
    )
