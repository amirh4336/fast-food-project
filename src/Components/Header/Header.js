...
export default function Header() {
    ...
    return (
        <div className={`grid grid-cols-12 bg-[#F2F1EE] fixed w-full top-0 z-40 items-center justify-between py-4 px-4 shadow-sm transition-all duration-300  ${ headerState ? 'delay-300' : ' -translate-y-20 delay-100'}`}>
